...
namespace HansDietrich {
	...
	CXButtonXP& CXButtonXP::SetIcon(UINT nIDResource, UINT nIDResourceGray, ICON_ALIGNMENT ia /*= LEFT*/)
		//=============================================================================	
	{
		...
		if (nIDResourceGray)
		{
			hIconGray = (HICON)LoadImage(AfxGetInstanceHandle(),
				MAKEINTRESOURCE(nIDResourceGray),
				IMAGE_ICON,
				0,
				0,
				0);
		...
		return SetIcon(hIcon, hIconGray, ia);
	}

	//=============================================================================	
	// Sets icon from HICON
	CXButtonXP& CXButtonXP::SetIcon(HICON hIcon, HICON hIconGray, ICON_ALIGNMENT ia /*= LEFT*/)
		//=============================================================================	
	{
		if (m_hIcon)
			DestroyIcon(m_hIcon);
