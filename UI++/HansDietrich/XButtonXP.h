...
//=============================================================================
	...
	public:
		...
		//=============================================================================
	public:
		CXButtonXP & SetIcon(UINT nIDResource, UINT nIDResourceGray = 0, ICON_ALIGNMENT ia = LEFT);
		CXButtonXP& SetIcon(HICON hIcon, HICON hIconGray = 0, ICON_ALIGNMENT ia = LEFT);
